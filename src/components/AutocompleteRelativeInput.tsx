        ...
        <div className="grid gap-2">
            ...
            <div className="flex items-center gap-2">
                <div className="relative w-full">
                     <div 
                        className={cn(
                            "flex h-11 w-full items-center gap-2 rounded-md border border-input bg-muted px-3 py-2 text-sm min-h-[44px]", 
                     ...
                     >
                        {hasSelection ? (
                            ...
                            <span className='text-muted-foreground text-sm'>Tap to select...</span>
                        )}
                    </div>
                </div>
